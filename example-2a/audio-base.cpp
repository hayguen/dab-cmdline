...
void audioBase::audioOut(int16_t *buffer, int32_t amount, int32_t rate) {
  switch (rate) {
    case 16000:
...
void audioBase::audioOut(SNDFILE *f, int16_t *buffer, int32_t amount,
                         int32_t rate) {
  switch (rate) {
    case 16000:
...
void audioBase::audioOut_16000(SNDFILE *f, int16_t *V, int32_t amount) {
  ...
  for (i = 0; i < amount; i++)
    if (converter_16.convert(
            DSPCOMPLEX(V[2 * i] / 32767.0, V[2 * i + 1] / 32767.0),
            outputBuffer, &result)) {
      for (j = 0; j < result; j++) {
...
//	amount gives number of pairs
void audioBase::audioOut_24000(SNDFILE *f, int16_t *V, int32_t amount) {
...
void audioBase::audioOut_32000(SNDFILE *f, int16_t *V, int32_t amount) {
...
void audioBase::audioOut_48000(SNDFILE *f, int16_t *V, int32_t amount) {
