...
class reader {
 ...
 public:
  ...
  virtual void restartReader(int32_t s) { blockSize = s; }
  ...
  virtual int16_t bitDepth(void) { return 12; }
};
...
class reader_16 : public reader {
 public:
  ...
  int16_t bitDepth(void) { return 16; }
};
...
class reader_24 : public reader {
 public:
  ...
  int16_t bitDepth(void) { return 24; }
};
...
class reader_32 : public reader {
 public:
  ...
  int16_t bitDepth(void) { return 32; }
};
