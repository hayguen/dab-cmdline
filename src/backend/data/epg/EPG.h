...
class EPGTime {
  EPGTime(void) : time(0), actualTime(0), duration(0), actualDuration(0) {}
...
class EPGRelativeTime {
  EPGRelativeTime(void)
      : time(0), actualTime(0), duration(0), actualDuration(0) {}
...
class EPG {
 public:
  EPG(CParameter&);
  virtual ~EPG(void) { saveChannels(servicesFilename); }
